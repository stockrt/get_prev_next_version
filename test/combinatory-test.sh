...
it_goes_prev_1_comb_0_10 () {
    ret="$($tool 1 prev 0.10)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_1_comb_0_99 () {
    ret="$($tool 1 prev 0.99)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_1_comb_0_100 () {
    ret="$($tool 1 prev 0.100)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_1_comb_0_999 () {
    ret="$($tool 1 prev 0.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_prev_1_comb_1_10 () {
    ret="$($tool 1 prev 1.10)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_1_comb_1_99 () {
    ret="$($tool 1 prev 1.99)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_1_comb_1_100 () {
    ret="$($tool 1 prev 1.100)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_1_comb_1_999 () {
    ret="$($tool 1 prev 1.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_prev_2_comb_0_10 () {
    ret="$($tool 2 prev 0.10)"
    test "$ret" = "0.9"
}

it_goes_prev_2_comb_0_99 () {
    ret="$($tool 2 prev 0.99)"
    test "$ret" = "0.98"
}

it_goes_prev_2_comb_0_100 () {
    ret="$($tool 2 prev 0.100)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_2_comb_0_999 () {
    ret="$($tool 2 prev 0.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_prev_2_comb_1_10 () {
    ret="$($tool 2 prev 1.10)"
    test "$ret" = "1.9"
}

it_goes_prev_2_comb_1_99 () {
    ret="$($tool 2 prev 1.99)"
    test "$ret" = "1.98"
}

it_goes_prev_2_comb_1_100 () {
    ret="$($tool 2 prev 1.100)"
    test "$ret" = "$err_field_size"
}

it_goes_prev_2_comb_1_999 () {
    ret="$($tool 2 prev 1.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_prev_3_comb_0_10 () {
    ret="$($tool 3 prev 0.10)"
    test "$ret" = "0.9"
}

it_goes_prev_3_comb_0_99 () {
    ret="$($tool 3 prev 0.99)"
    test "$ret" = "0.98"
}

it_goes_prev_3_comb_0_100 () {
    ret="$($tool 3 prev 0.100)"
    test "$ret" = "0.99"
}

it_goes_prev_3_comb_0_999 () {
    ret="$($tool 3 prev 0.999)"
    test "$ret" = "0.998"
}
...
it_goes_prev_3_comb_1_10 () {
    ret="$($tool 3 prev 1.10)"
    test "$ret" = "1.9"
}

it_goes_prev_3_comb_1_99 () {
    ret="$($tool 3 prev 1.99)"
    test "$ret" = "1.98"
}

it_goes_prev_3_comb_1_100 () {
    ret="$($tool 3 prev 1.100)"
    test "$ret" = "1.99"
}

it_goes_prev_3_comb_1_999 () {
    ret="$($tool 3 prev 1.999)"
    test "$ret" = "1.998"
}
...
it_goes_next_1_comb_0_10 () {
    ret="$($tool 1 next 0.10)"
    test "$ret" = "$err_field_size"
}

it_goes_next_1_comb_0_99 () {
    ret="$($tool 1 next 0.99)"
    test "$ret" = "$err_field_size"
}

it_goes_next_1_comb_0_100 () {
    ret="$($tool 1 next 0.100)"
    test "$ret" = "$err_field_size"
}

it_goes_next_1_comb_0_999 () {
    ret="$($tool 1 next 0.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_next_1_comb_1_10 () {
    ret="$($tool 1 next 1.10)"
    test "$ret" = "$err_field_size"
}

it_goes_next_1_comb_1_99 () {
    ret="$($tool 1 next 1.99)"
    test "$ret" = "$err_field_size"
}

it_goes_next_1_comb_1_100 () {
    ret="$($tool 1 next 1.100)"
    test "$ret" = "$err_field_size"
}

it_goes_next_1_comb_1_999 () {
    ret="$($tool 1 next 1.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_next_2_comb_0_10 () {
    ret="$($tool 2 next 0.10)"
    test "$ret" = "0.11"
}

it_goes_next_2_comb_0_99 () {
    ret="$($tool 2 next 0.99)"
    test "$ret" = "1.0"
}

it_goes_next_2_comb_0_100 () {
    ret="$($tool 2 next 0.100)"
    test "$ret" = "$err_field_size"
}

it_goes_next_2_comb_0_999 () {
    ret="$($tool 2 next 0.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_next_2_comb_1_10 () {
    ret="$($tool 2 next 1.10)"
    test "$ret" = "1.11"
}

it_goes_next_2_comb_1_99 () {
    ret="$($tool 2 next 1.99)"
    test "$ret" = "2.0"
}

it_goes_next_2_comb_1_100 () {
    ret="$($tool 2 next 1.100)"
    test "$ret" = "$err_field_size"
}

it_goes_next_2_comb_1_999 () {
    ret="$($tool 2 next 1.999)"
    test "$ret" = "$err_field_size"
}
...
it_goes_next_3_comb_0_10 () {
    ret="$($tool 3 next 0.10)"
    test "$ret" = "0.11"
}

it_goes_next_3_comb_0_99 () {
    ret="$($tool 3 next 0.99)"
    test "$ret" = "0.100"
}

it_goes_next_3_comb_0_100 () {
    ret="$($tool 3 next 0.100)"
    test "$ret" = "0.101"
}

it_goes_next_3_comb_0_999 () {
    ret="$($tool 3 next 0.999)"
    test "$ret" = "1.0"
}
...
it_goes_next_3_comb_1_10 () {
    ret="$($tool 3 next 1.10)"
    test "$ret" = "1.11"
}

it_goes_next_3_comb_1_99 () {
    ret="$($tool 3 next 1.99)"
    test "$ret" = "1.100"
}

it_goes_next_3_comb_1_100 () {
    ret="$($tool 3 next 1.100)"
    test "$ret" = "1.101"
}

it_goes_next_3_comb_1_999 () {
    ret="$($tool 3 next 1.999)"
    test "$ret" = "2.0"
}
